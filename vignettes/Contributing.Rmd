...
We periodically merge `dev` into `master` for small release updates. These releases will appear on the [GitHub releases page](https://github.com/dd-harp/MicroWNV/releases). 
...
runs during pull requests to `[main, dev]` and uses our [codecov.io integration](https://app.codecov.io/gh/dd-harp/MicroWNV)
